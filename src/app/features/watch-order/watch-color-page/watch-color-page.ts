...
export class WatchColorPage {
  ...
  colors = [
    { id: 'model1', name: 'Gümüş', color: 'bg-gray-300', image: '/ziraati/watch1.jpeg' },
    ...
    { id: 'model4', name: 'Titanyum', color: 'bg-slate-400', image: '/ziraati/watch4.jpeg' },
    { id: 'model5', name: 'Gece Mavisi', color: 'bg-blue-900', image: '/ziraati/watch5.jpeg' }
  ];
